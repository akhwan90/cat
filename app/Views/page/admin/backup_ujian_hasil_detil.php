						...
						<div class="card-body">
							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
									...
									<a href="<?=base_url('/admin/ujian/cetak_1/'.$id_ujian.'/'.$id_peserta);?>" class="btn btn-primary btn-lg mb-3" target="_blank">Cetak</a>
									<a href="<?=base_url('/admin/ujian/lihat_hasil/'.$id_ujian);?>" class="btn btn-secondary btn-lg mb-3" >Kembali</a>
