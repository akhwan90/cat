...
<div class="modal fade" id="mdl_edit" tabindex="-1" role="dialog" aria-labelledby="mdl_edit" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form method="post" action="#" id="mdl_edit_form">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<small class="text-danger">*) Kosongkan jika password tidak ingin diubah..</small>
					...
					<div class="form-group">
						...
						<?=form_dropdown('level', $p_level, '', 'class="form-control" id="level"');?>
					</div>
				</div>
