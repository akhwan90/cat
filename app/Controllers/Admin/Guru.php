...
class Guru extends BaseController {
	...
	public function form_import() {
		$d['p'] = 'admin/guru_form_import';
		$d['js'] = 'guru';
		$d['title'] = 'Import Data Guru';
	...
	public function datatabel() {
        ...
        if ($this->request->isAJAX()) {
            ...
            $builder->orLike('nip', $search['value']);
            $builder->groupEnd();
            $builder->select('id');
            ...
            foreach ($q_datanya as $d) {
                ...
                $username = $d['username'];
                if (empty($username)) {
                	$username = '<a href="#" onclick="return aktifkan_user_satu(\''.$d['nip'].'\');" class="btn btn-primary btn-sm" title="Aktifkan user"><i class="fa fa-user"></i> Aktifkan User</a>';
                }
